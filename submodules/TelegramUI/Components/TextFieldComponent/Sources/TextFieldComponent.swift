...
public final class TextFieldComponent: Component {
    ...
    public final class View: UIView, UIScrollViewDelegate, ChatInputTextNodeDelegate {
        ...
        public func chatInputTextNodeShouldReturn() -> Bool {
            return self.chatInputTextNodeShouldReturnInternal(modifierFlags: [])
        }
        
        public func chatInputTextNodeShouldReturn(modifierFlags: UIKeyModifierFlags) -> Bool {
            return self.chatInputTextNodeShouldReturnInternal(modifierFlags: modifierFlags)
        }
        
        private func chatInputTextNodeShouldReturnInternal(modifierFlags: UIKeyModifierFlags) -> Bool {
            guard let component = self.component else {
                return true
            }
